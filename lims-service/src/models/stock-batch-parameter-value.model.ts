...
export class StockBatchParameterValue
  extends Model<IStockBatchParameterValue>
  implements IStockBatchParameterValue
{
  public id!: string;
...
StockBatchParameterValue.init(
  ...
  {
    sequelize,
    tableName: "lims_stock_batch_parameter_values",
    underscored: true,
    timestamps: true
  }
);
