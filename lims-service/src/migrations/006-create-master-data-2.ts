...
export const up = async (queryInterface: QueryInterface) => {
  ...
  await queryInterface.addIndex("lims_stock_batch_consumptions", [
    "stock_batch_id"
  ]);
  ...
  await queryInterface.addIndex("lims_stock_batch_parameter_values", [
    "stock_batch_id"
  ]);
