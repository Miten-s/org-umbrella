...
export const createCalibrationScheduleRepo = async (data: any, transaction?: Transaction) => {
  return await CalibrationSchedule.create(data, { transaction });
};
...
export const getCalibrationScheduleByIdRepo = async (id: string, transaction?: Transaction) => {
  return await CalibrationSchedule.findOne({ 
...
export const getAllCalibrationSchedulesRepo = async (skip: number, limit: number, filters: any = {}) => {
  return await CalibrationSchedule.findAndCountAll({
