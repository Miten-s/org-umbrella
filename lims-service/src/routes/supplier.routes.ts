...
router.patch(API_ROUTES.PARAMS, validateDto(IsValidParamsIdDto, "params"), validateDto(UpdateSupplierDto, "body"), auditMiddleware(ENTITY_NAME, true), controller.updateSupplier);
