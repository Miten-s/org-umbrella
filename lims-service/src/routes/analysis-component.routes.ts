...
router.patch(API_ROUTES.PARAMS, validateDto(IsValidParamsIdDto, "params"), validateDto(UpdateAnalysisComponentDto, "body"), auditMiddleware(ENTITY_NAME, true), controller.updateAnalysisComponent);
