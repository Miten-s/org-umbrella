...
router.patch(API_ROUTES.PARAMS, validateDto(IsValidParamsIdDto, "params"), validateDto(UpdateAnalysisDto, "body"), auditMiddleware(ENTITY_NAME, true), controller.updateAnalysis);
