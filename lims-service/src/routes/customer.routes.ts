...
router.patch(API_ROUTES.PARAMS, validateDto(IsValidParamsIdDto, "params"), validateDto(UpdateCustomerDto, "body"), auditMiddleware(ENTITY_NAME, true), controller.updateCustomer);
