...
router.patch(API_ROUTES.PARAMS, validateDto(IsValidParamsIdDto, "params"), validateDto(UpdateLotDto, "body"), auditMiddleware(ENTITY_NAME, true), controller.updateLot);
