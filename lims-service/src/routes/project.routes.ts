...
router.patch(API_ROUTES.PARAMS, validateDto(IsValidParamsIdDto, "params"), validateDto(UpdateProjectDto, "body"), auditMiddleware(ENTITY_NAME, true), controller.updateProject);
