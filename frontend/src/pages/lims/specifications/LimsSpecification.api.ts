...
export const fetchLimsSpecificationList = async (
...
export const fetchLimsSpecificationOptions = async (
...
const toBody = (payload: LimsSpecificationPayload, files?: File[]) => {
...
export const updateLimsSpecification = async (
  id: string,
...
export const bulkDeleteLimsSpecification = async (
...
export const bulkRestoreLimsSpecification = async (
  selection: BulkSelection,
  changeReason: string
) => {
...
export const bulkUpdateLimsSpecification = async (
