...
export const fetchLimsSupplierById = async (
  id: string,
  signal?: AbortSignal
) => {
...
export const fetchLimsSupplierList = async (
  ...
  return toListResult<LimsSupplier>(
    response.data,
    params,
    DATA_KEYS,
    RELATION_KEYS
...
export const createLimsSupplier = async (
...
export const bulkRestoreLimsSupplier = async (
  selection: BulkSelection,
  changeReason: string
) => {
