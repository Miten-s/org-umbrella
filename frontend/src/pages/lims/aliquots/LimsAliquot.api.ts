...
export const fetchLimsAliquotById = async (
  id: string,
  signal?: AbortSignal
) => {
...
export const fetchLimsAliquotList = async (
  ...
  return toListResult<LimsAliquot>(
    response.data,
    params,
    DATA_KEYS,
    RELATION_KEYS
...
export const updateLimsAliquot = async (
  id: string,
...
export const bulkRestoreLimsAliquot = async (
  selection: BulkSelection,
  changeReason: string
) => {
 ...
 */
export const bulkCopyLimsAliquot = async (records: LimsAliquotPayload[]) => {
...
export const bulkUpdateLimsAliquot = async (
