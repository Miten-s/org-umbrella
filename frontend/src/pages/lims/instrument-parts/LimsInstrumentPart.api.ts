...
const DATA_KEYS = ["instrumentParts", "data"];
const RELATION_KEYS = ["group", "status", "location", "supplier", "instrument"];

export const fetchLimsInstrumentPartList = async (
...
export const fetchLimsInstrumentPartOptions = async (
  ...
  return toOptionsPage<LimsInstrumentPart>(
    response.data,
    params,
    (row) => String(row.partName ?? ""),
    DATA_KEYS
  );
};

const toBody = (payload: LimsInstrumentPartPayload, files?: File[]) => {
...
export const updateLimsInstrumentPart = async (
  id: string,
...
export const bulkDeleteLimsInstrumentPart = async (
...
export const bulkRestoreLimsInstrumentPart = async (
  selection: BulkSelection,
  changeReason: string
) => {
...
export const bulkUpdateLimsInstrumentPart = async (
...
export const fetchLimsInstrumentPartAudit = async (
  id: string,
  signal?: AbortSignal,
