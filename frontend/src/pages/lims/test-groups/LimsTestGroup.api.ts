...
export const fetchLimsTestGroupById = async (
  id: string,
  signal?: AbortSignal
) => {
...
export const fetchLimsTestGroupList = async (
  ...
  return toListResult<LimsTestGroup>(
    response.data,
    params,
    DATA_KEYS,
    RELATION_KEYS
...
export const fetchLimsTestGroupOptions = async (
  ...
  return toOptionsPage<LimsTestGroup>(
    response.data,
    params,
    (row) => row.name,
    DATA_KEYS
...
export const updateLimsTestGroup = async (
  id: string,
...
export const bulkRestoreLimsTestGroup = async (
  selection: BulkSelection,
  changeReason: string
) => {
 ...
 */
export const bulkCopyLimsTestGroup = async (
  records: LimsTestGroupPayload[]
) => {
...
export const bulkUpdateLimsTestGroup = async (
...
export const restoreLimsTestGroup = async (
  id: string,
  changeReason: string
) => {
