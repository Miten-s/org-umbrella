...
export const fetchLimsCustomerById = async (
  id: string,
  signal?: AbortSignal
) => {
...
export const fetchLimsCustomerList = async (
  ...
  return toListResult<LimsCustomer>(
    response.data,
    params,
    DATA_KEYS,
    RELATION_KEYS
...
export const createLimsCustomer = async (
...
export const bulkRestoreLimsCustomer = async (
  selection: BulkSelection,
  changeReason: string
) => {
...
export const bulkUpdateLimsCustomer = async (
