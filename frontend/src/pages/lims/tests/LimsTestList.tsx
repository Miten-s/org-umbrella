...
import { fetchLimsTestById, fetchLimsTestList } from "./LimsTest.api";
...
const LimsTestList = () => {
  ...
  // List rows lack attachments (see LimsTest.api.ts); full record is fetched by id on demand.
  ...
  const detailQuery = useLimsTestById(
    activeId ?? undefined,
  ...
  const bulkRestoreTest = useBulkRestoreLimsTest();
  ...
  return (
    <div className="flex flex-col lg:h-[calc(100dvh-132px)] lg:min-h-0">
      ...
      >
        {copyIds ? (
          <CopyStepper<LimsTest, LimsTestPayload>
            ids={copyIds}
      ...
      <LimsComplianceDialogs
        ...
        bulkRestoring={bulkRestoreTest.isPending}
        ...
        onBulkRestore={async (reason) => {
          ...
          if (pending) {
            await bulkRestoreTest.mutateAsync({
